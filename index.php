...
***************************************/
    ...
    $sitename = 'Sample Quix';
    $sitedescription = 'Sample Quiz';
    $author = 'Alvin Ngugi';
    
    $note = 'If you dont click an answer, the marks for that question will be marked <strong>ZERO</strong> changes cannot be undone.';
...
<!--    meta-->
    ...
    <meta name="author" content="Alvin Ngugi">
    <meta name="viewport" content="width=device-width, initial-scale=1.0"> 
    <meta name="keywords" content="Alvin, Ngugi, Sample, Quiz, Open-Source, PHP">
